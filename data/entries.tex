...
\textbf{abarudu} [ʔabaɾu'du] \textit{S.} -- árvore de embira (gênero) [link: https://pt.wikipedia.org/wiki/Daphnopsis]Daphnopsis) [image: https://upload.wikimedia.org/wikipedia/commons/8/86/Daphnopsis_hellerana.jpg]

\textbf{abawazi} [ʔabawa'zi] \textit{S.} -- timbó.
...
\textbf{arãrã nhi'u} suco de beija-flor, néctar. 

\textbf{nhi'umadtõ} [nhiʔumadtõ] suco de beija-flor, néctar.

\textbf{mara nhi'umadtõ} três noite \textit{S.} -- 

\textbf{nhi'uwa} [nhiʔuwa] \textit{ADJ.} -- leve, tenro, suave.
...
\textbf{nho'remhã} [nhoʔremhã] \textit{POSP.} estando em frente de. 

\textbf{nho'ré}  [nhoʔré] \textit{S.} -- fila, leitura.
